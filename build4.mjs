...
function markVelocity(theme = "dark") {
  ...
  const trails = `
    <g stroke-linecap="round" fill="none">
      <line x1="22" y1="104" x2="86" y2="100"  stroke="url(#${trailGrad})" stroke-width="9"  opacity="0.55"/>
      <line x1="14" y1="126" x2="92" y2="122"  stroke="url(#${trailGrad})" stroke-width="13" opacity="0.85"/>
      <line x1="26" y1="150" x2="84" y2="146"  stroke="url(#${trailGrad})" stroke-width="10" opacity="0.7"/>
      <line x1="40" y1="170" x2="80" y2="168"  stroke="url(#${trailGrad})" stroke-width="7"  opacity="0.5"/>
    </g>`;
  ...
  const t = `
    <g filter="url(#${drop})">
      <!-- crossbar -->
      <path d="M48 44 L170 44 L158 76 L48 76 Z" fill="url(#amberFlat)"/>
      <!-- stem leaning forward -->
      <path d="M112 44 L158 44 L116 176 L82 176 Z" fill="url(#amber)"/>
      <!-- crossbar top bevel highlight -->
      <path d="M48 44 L170 44 L166 54 L48 54 Z" fill="#FFE49A" opacity="0.45"/>
      <!-- stem leading-edge highlight -->
      <path d="M146 44 L158 44 L120 162 L110 162 Z" fill="#FFE08A" opacity="0.5"/>
    </g>`;
